...
// import exclamationActive from '../../assets/icons/exclamation-active.svg'

const ExclamationBtn = styled.button`
    ...
    const elements = data.map(item => {
        ...
        return (
            <li key={id} className={s.TodoList__li}>
                <TodoListItem {...rest} />
                <div className={s.TodoList__buttons}>
                    <button className={s.TodoList__remove}>
                    ...
                    <ExclamationBtn className={s.TodoList__check} />
                </div>
            </li>
        );
    });
